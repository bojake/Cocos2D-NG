...
//            m_localYAxisA = b2Math.b2Cross(1.0f, m_localXAxisA);
        ...
        public override bool SolvePositionConstraints(b2SolverData data)
        {
            ...
            float k = m_invMassA + m_invMassB + m_invIA * sAy * sAy + m_invIB * sBy * sBy;
        ...
        public virtual float GetJointSpeed()
        {
            ...
            b2Vec2 crossWAaxis = b2Math.b2Cross(wA, ref axis);
            b2Vec2 crossWBrB = b2Math.b2Cross(wB, ref rB);
            b2Vec2 crossWArA = b2Math.b2Cross(wA, ref rA);

            b2Vec2 temp = vB + crossWBrB - vA - crossWArA;

            float speed = b2Math.b2Dot(ref d, ref crossWAaxis) + b2Math.b2Dot(ref axis, ref temp);
            return speed;
        }
