...
using CocosNG.Core.Nodes.Sprites;
...
namespace CocosNG.Core
{
    public static class CCDrawManager
    {
        ...
        internal static Matrix4x4 m_worldMatrix;
        internal static Matrix4x4 m_viewMatrix;
        internal static Matrix4x4 m_projectionMatrix;

        private static readonly Matrix4x4[] m_matrixStack = new Matrix4x4[100];
        private static int m_stackIndex;

        internal static Matrix4x4 m_Matrix;
        private static Matrix4x4 m_TmpMatrix;
