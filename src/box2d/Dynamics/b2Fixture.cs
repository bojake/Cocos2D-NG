                ...
                case b2ShapeType.e_circle:
                    {
                        ...
                        System.Diagnostics.Debug.WriteLine("    shape.m_p.Set({0:N5}, {1:N5});", s.Position.x, s.Position.y);
                    }
                    break;
                ...
                case b2ShapeType.e_edge:
                    {
                        ...
                        System.Diagnostics.Debug.WriteLine("    shape.m_radius = {0:N5};", s.Radius);
                        System.Diagnostics.Debug.WriteLine("    shape.m_vertex0.Set({0:N5}, {1:N5});", s.Vertex0.x, s.Vertex0.y);
                        System.Diagnostics.Debug.WriteLine("    shape.m_vertex1.Set({0:N5}, {1:N5});", s.Vertex1.x, s.Vertex1.y);
                        System.Diagnostics.Debug.WriteLine("    shape.m_vertex2.Set({0:N5}, {1:N5});", s.Vertex2.x, s.Vertex2.y);
                        System.Diagnostics.Debug.WriteLine("    shape.m_vertex3.Set({0:N5}, {1:N5});", s.Vertex3.x, s.Vertex3.y);
                ...
                case b2ShapeType.e_polygon:
                    {
                        ...
                        {
                            System.Diagnostics.Debug.WriteLine("    vs[{0}].Set({1:N5}, {2:N5});", i, s.Vertices[i].x, s.Vertices[i].y);
                        }
                ...
                case b2ShapeType.e_chain:
                    {
                        ...
                        System.Diagnostics.Debug.WriteLine("    shape.PrevVertex.Set({0:N5}, {1:N5});", s.PrevVertex.x, s.PrevVertex.y);
                        System.Diagnostics.Debug.WriteLine("    shape.NextVertex.Set({0:N5}, {1:N5});", s.NextVertex.x, s.NextVertex.y);
